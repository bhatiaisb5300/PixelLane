...
angular.module("views/generate.html", []).run(["$templateCache", function(e) {
    e.put("views/generate.html", '<div class="view-generate" layout="column">    <div data-qr-generate-widget data-qrcode="qrcode"></div>    <div class="convert-dynamic" data-ng-show="modified && isOnline" layout-padding>        Do you need to change the content of the QR Code after it has been printed?        Or do you need statistics?        <a href="" data-ng-click="convertToDynamic()">            <span data-ng-show="$root.auth.isSignedIn">Convert your Code to a Dynamic QR                Code.</span>            <span data-ng-hide="$root.auth.isSignedIn">Sign In with Google and convert your                Code to a Dynamic QR Code.</span>        </a>    </div>    <div goog-bottom-ad class="google-bottom"></div></div>')
}
]),
...
angular.module("qrAppDev", ["qrApp"]),
"qr.w69b.com" == window.location.hostname && (window.location.href = "https://www.the-qrcode-generator.com"),
w69b.qr.decoding.setWorkerUrl("components/barcode.js/w69b.qrcode.decodeworker.min.js"),
angular.module("qrApp.routes", ["qrApp.services", "ngRoute"]).config(["$routeProvider", "$locationProvider", function(e, t) {
    e.when("/", {
...
]).run(["authRoutes", function() {}
]),
angular.module("qrApp.offline", []).run(["$rootScope", "$window", "$document", "constants", function(e, t, n, o) {
    function a() {
        e.isOnline = t.navigator.onLine !== !1,
        t.navigator.userAgent.match(/PhantomJS/) && (e.isOnline = !0)
    }
    function r(e) {
        return new Promise(function(t, n) {
            if (e.installing) {
                ...
                o.addEventListener("statechange", function a(e) {
                    "installed" == e.target.state ? (o.removeEventListener("statechagne", a),
                    t()) : "redundant" == e.target.state && (o.removeEventListener("statechagne", a),
                    n())
                })
            } else
                t()
    ...
    function i() {
        return new Promise(function(e, t) {
            ...
            n ? n.controller ? e() : n.addEventListener("controllerchange", function o() {
                n.controller && (n.removeEventListener("controllerchange", o),
                e())
    ...
    function s() {
        "serviceWorker"in navigator && navigator.serviceWorker.register("/serviceworker.js", {
            scope: "/"
        }).then(r).then(i).then(function() {}).catch(function(e) {
            console.error("service worker installation failed", e)
        })
    }
    a(),
    o.OFFLINE_SUPPORT && (t.addEventListener("online", function() {
        e.$apply(a)
    }),
...
angular.module("qrApp.services", ["ngResource", "ngMaterial", "ngSanitize", "qrApp.analytics", "qr.toolbar"]),
angular.module("qrApp.ctrls", ["qrApp.services", "qrApp.analytics", "ngMaterial", "w69b.throttle"]),
angular.module("qrApp.directives", ["qrApp.ctrls", "qrApp.constants", "ngMaterial", "templates"]),
angular.module("qrApp.ctrls").controller("ScanCtrl", ["$scope", "qrContentParser", "qrAudio", "backStack", "analytics", function(e, t, n, o, a) {
    e.isScanning = !0,
    e.onDecoded = function(r) {
        n.beep(),
        e.decoded = t.parse(r),
        a.trackEvent("Scan", "Decoded", e.decoded.type),
        e.isScanning = !1,
        o.push(function() {
            e.isScanning = !0
        })
...
angular.module("qrApp.ctrls").controller("AppCtrl", ["$scope", "$mdSidenav", "$mdMedia", "toolbarSpinner", function(e, t, n, o) {
    e.scanSupported = w69b.qr.ui.ContinuousScanner.isSupported(),
    e.$mdMedia = n,
    e.openMenu = function() {
        return t("left").open()
    }
...
angular.module("qrApp.directives").directive("qrScanning", ["$interval", function(e) {
    return {
        ...
        link: function(t, n, o) {
            ...
            s && l.setMaxVisualizationResolution(Number(c)),
            s && l.setMaxDecodingResolution(Number(s)),
            l.render(r)
        }
    }
}
    ...
    return {
        ...
        link: function(e, t) {
            t.bind("click", function(t) {
                var n = t.target;
                "a" == angular.lowercase(n.tagName) && (t.preventDefault(),
                e.openURL(n.href))
            })
        }
    }
...
angular.module("qrApp.services").factory("qrContentParser", ["QrContent", function(e) {
        ...
        for (var a = {}, i = 1; t.length > i; ++i) {
            ...
            if (d) {
                var u = angular.lowercase(d[1])
                  , p = d[2]
                  , m = null;
                p && (m = angular.lowercase(p.split(";")[0])),
                m = m || "home";
                var h = d[3];
                h = s(h, ";").map(r),
                a[u] = a[u] || [],
    ...
    function l(t) {
        ...
        var a = {};
        return t.org && (a.organization = n("org")),
        t.email && (a.emails = o("email")),
        t.tel && (a.telephones = o("tel")),
        t.adr && (a.addresses = o("adr")),
        t.url && (a.urls = o("url")),
        t.n ? (a.name = t.n[0][0],
        a.firstname = t.n[0].slice(1).join(" ").trim()) : t.fn && (a.name = n("fn")),
        _.isEmpty(a) ? null : new e("contact",a)
    }
    function d(t) {
        var n = /^geo:([\-\d\.]+),([\-\d\.]+)(?:,([\-\d\.]+))?(?:\?(.*))?$/i
          , o = n.exec(t);
...
angular.module("qrApp.services").factory("qrAudio", ["$window", function(e) {
    ...
    var n;
    angular.isDefined(e.Audio) ? n = e.Audio : (n = function() {}
    ,
...
angular.module("qrApp.services").factory("webActivities", ["$window", function(e) {
    ...
    function i(e) {
        if (h) {
            ...
            n.type = "file";
            var o = function() {
                n.files.length && e(n.files[0]),
                n.removeEventListener("change", o, !1)
            };
            n.addEventListener("change", o, !1),
            n.click()
        }
    }
    function s() {
    ...
    function c(e) {
        if (h) {
            var t = {};
            e.telephones && e.telephones.length > 0 && (t.tel = e.telephones[0]),
            e.firstname && (t.giveName = e.firstname),
            e.name && (t.familyName = e.name),
            e.emails && e.emails.length > 0 && (t.email = e.emails[0]),
            e.organization && (t.company = e.organization),
            e.addresses && e.addresses.length > 0 && (t.address = e.addresses[0]),
            new MozActivity({
                name: "new",
                data: {
                    type: "webcontacts/contact",
...
angular.module("qrApp.ctrls").controller("ParsedContentCtrl", ["$scope", "webActivities", function(e, t) {
    e.canComposeSMS = t.isComposeSMSSupported(),
    e.canSaveContact = t.isSaveContactSupported(),
    e.openURL = t.openURL,
    e.openDialer = t.openDialer,
    e.composeEmail = t.composeEmail,
    e.composeSMS = t.composeSMS,
    e.saveContact = t.saveContact
}
]),
angular.module("qrApp.services").factory("fallbackDecoder", ["$window", function(e) {
    function t(t, o) {
        ...
        r.onload = function() {
            ...
            angular.isString(t) || e.URL.revokeObjectURL(a),
            n(i, o)
        }
        ,
        r.src = a
...
angular.module("qrApp.ctrls").controller("GenerateWidgetCtrl", ["$scope", "qrContentEncoder", "qrEncoder", "webActivities", "analytics", "$timeout", "zazzle", "statusbar", "$mdDialog", function(e, t, n, o, a, r, i, s, c) {
    ...
    function d(t) {
        n.getPngBlob(e.encodedContent, l(), e.options.margin, function(e) {
            o.saveBlob(e, t),
            a.trackEvent("Generate", "Save", "saved png")
        })
    }
    function u(t) {
        ...
        a.trackEvent("Generate", "Save", "saved svg")
    }
    function p(t) {
        ...
        a.trackEvent("Generate", "Save", "saved eps")
    }
    var m = 200;
    e.optionsShown = 0,
    e.options = {
    ...
    e.zazzleRunning = !1,
    e.$watch("options.noMargin", function(t) {
        e.options.margin = t ? 0 : 1
    }),
    e.$watch("[qrcode, staticContent]", _.throttle(function() {
        e.encodedContent = e.staticContent ? e.staticContent : e.qrcode && e.qrcode.type ? t.encode(e.qrcode) : "",
        e.$root.$$phase || e.$apply()
    }, 200), !0),
    e.$watch("[options, encodedContent]", function() {
        var t = e.options.size;
        if (!n.isSupported())
            return e.qrCodeSize = t,
            void 0;
        var o = n.getSize(e.encodedContent);
        1 > e.options.margin && (t = Math.floor(t / o) * o),
        o > t && (t = o),
        e.qrCodeSize = t
    }, !0),
    e.$watch("qrCodeSize", function(t) {
        e.showClamped = t > m,
        e.clampedSize = Math.min(Math.max(t, 0), m)
    }),
    e.save = function(e) {
        a.trackEvent("Generate", "Save", "Dialog"),
        c.show({
    ...
    e.printWithZazzle = function() {
        if (!e.zazzleRunning) {
            if (!e.encodedContent.length)
                return s.showMessage("Please enter something first.", 2e3),
                void 0;
            e.zazzleRunning = !0,
            a.trackEvent("Zazzle", "Prepare", e.qrcode.type),
            i.prepareProducts(e.encodedContent, e.qrcode).then(function() {
                e.zazzleRunning = !1
            })
        }
    }
...
angular.module("qrApp.ctrls").controller("QrShareableCodeCtrl", ["$scope", "qrEncoder", "webActivities", function(e, t, n) {
    e.canSave = n.isSaveBlobSupported(),
    e.canShare = n.isShareBlobSupported(),
    e.share = function() {
...
angular.module("qrApp.services").factory("qrEncoder", function() {
    ...
    function n(t, n, o, a) {
        ...
        r.height = n,
        e(t, r, o),
        w69b.imgtools.getCanvasAsBlob(r, a)
    }
    function o(e, t, n) {
    ...
    return {
        ...
        link: function(t, n, o) {
            ...
            t.$watch("show", function(e) {
                n.css("display", e === !1 ? "none" : ""),
                a()
            }),
            s.bind("resize", t.$apply.bind(t, a)),
...
angular.module("qrApp.directives").controller("TabbedInputsCtrl", ["$scope", "$http", "statusbar", function(e, t, n) {
    ...
    e.$watch(o, function(t) {
        e.model = t
    }, !0),
    e.shortenURL = function() {
        var o = e.data.url;
        /^https?:\/\//.test(o) || (o = "http://" + o),
        e.shortenButtonDisabled = !0,
        n.showMessage("Shortening URL...", 0),
        t.post("/api/shorten", o).success(function(t) {
            var a = t.short_url;
            e.data.url = a,
            e.shortenButtonDisabled = !1,
            e.shortURLInfo.originalURL = o,
            e.shortURLInfo.shortURL = a,
            n.hide()
        }).error(function() {
            e.shortenButtonDisabled = !1,
            n.showError("Oups, we could not shorten the URL. Are you online?")
        })
    }
}
...
angular.module("qrApp.analytics", ["qrApp.constants"]).run(["$window", "$rootScope", "$location", "analytics", "constants", function(e, t, n, o, a) {
    ...
    a.ANALYTICS_ENABLE || (e["ga-disable-" + r] = !0),
    o.push(["_setAccount", r]),
    function() {
...
angular.module("qrApp.services").factory("qrContentEncoder", function() {
    ...
    function a(t) {
        var n = e();
        return n.addType("n", [t.name, t.firstname]),
        n.addType("org", t.organization),
        n.addType("email;type=internet", t.email),
        n.addType("url", t.url),
        n.addType("tel;type=cell", t.cell),
        n.addType("tel", t.phone),
        n.addType("tel;type=fax", t.fax),
        n.addType("adr", ["", "", t.street, t.city, t.region, t.postcode, t.country]),
        "" + n
    }
    function r(e) {
...
angular.module("qrApp.services").provider("statusbar", function() {
    ...
    this.$get = ["$document", "$timeout", "$compile", "$rootScope", "$window", "$mdTheming", function(t, n, o, a, r, i) {
        function s(e, t, o, a) {
            g && n.cancel(g),
            angular.isDefined(t) || (t = h),
            f.additionalClasses = o,
            f.message = e,
            f.shown = !0,
            f.closeable = a,
            t && (g = n(u, t))
        ...
        function l() {
            ...
            m.bind("click", function(e) {
                var t = e.target;
                "a" == angular.lowercase(t.tagName) && (e.preventDefault(),
                u(),
                f.$digest(),
                r.open(t.href))
            }),
        ...
        var m, h = 3e3, g = null, v = '<md-toast class="md-bottom md-left"data-ng-class="additionalClasses" data-ng-show="shown"><span flex>{{message}}</span><md-button class="md-action" ng-if="closeable" ng-click="close()">Close</md-button></md-toast>', f = a.$new(!0);
        return f.shown = !1,
        f.message = "",
        f.closeable = !0,
        f.additionalClasses = "",
...
angular.module("qrApp.constants").config(["constants", function(e) {
    e.SCAN_IFRAME_BASE = "https://www.the-qrcode-generator.com",
    e.SCAN_IFRAME_URL = e.SCAN_IFRAME_BASE + "/scan_embed.html",
    e.SCAN_IFRAME_ORIGIN = e.SCAN_IFRAME_BASE,
    e.ANALYTICS_ENABLE = !0,
    e.OFFLINE_SUPPORT = "serviceWorker"in navigator,
    e.IS_DEVELOPMENT = !1
}
]),
angular.module("qrApp.services").factory("zazzle", ["$http", "$q", "$mdToast", "strUtils", "statusbar", function(e, t, n, o, a) {
    function r(e) {
        ...
        if ("contact" == e.type) {
            ...
            a.length && (t.name = a.join(" ")),
            t.organization = o.organization || t.name,
            o.url && (n = s(o.url));
            var r = [o.email, o.phone, n].filter(_.isString);
            r.length && (2 > r.length && r.push(""),
            t.contact = r.join("\n"))
        } else
            "url" == e.type && (n = s(e.content));
        return n && (t.url = n),
        t
    }
    function i(o, i) {
        ...
        var c = r(i);
        return c.encoded = o,
        e.post("/api/zazzle", c).success(function(e) {
            var t = e.url;
            a.hide(),
            n.show({
                hideDelay: 1e4,
            ...
            a.showError("Oups, we could not communicate with our backend. Are you online?"),
            s.resolve()
        }),
        s.promise
    }
...
angular.module("qrApp.ctrls").controller("MyCodesCtrl", ["$scope", "qrBackend", "auth", "$location", "$mdDialog", "analytics", "toolbarSpinner", function(e, t, n, o, a, r, i) {
    ...
    e.create = function() {
        ...
        e.$save(function() {
            i.hide(),
            r.trackEvent("MyCodes", "Create", "new"),
            o.path("/mycodes/" + e.qrid)
        })
    }
}
    ...
    function d() {
        c.hide(),
        e.code.qrcode.isDynamic = !0,
        e.$watch("code", function(t, n) {
            angular.equals(t, n) || (e.touched = !0,
            e.dirty = !0,
            t.isVirgin = !1,
            m.modelChanged())
        }, !0)
    ...
    e.staticContent = null,
    e.settingsShown = t.hasOwnProperty("settings"),
    e.timezones = n.getTimezones();
    var m = o(function() {
        e.code.$save(l),
        c.show()
    })
    ...
    e.rename = function(t) {
        return a.show({
            ...
            t && (e.code.title = t,
            s.trackEvent("MyCodes", "Edit", "rename"))
        })
    }
    ,
    ...
    e.$on("$destroy", function() {
        m.flush(),
        e.code.isVirgin && !e.dirty && e.code.$delete(),
        r.onbeforeunload == p && (r.onbeforeunload = angular.noop)
    })
}
    ...
    function s() {
        r.show(),
        n.getStats(l, e.dateRange.from, e.dateRange.to).then(function(t) {
            e.views = t,
            r.hide()
        })
    }
    ...
    var l = t.qrid;
    a.trackPageView("/mycodes/stats"),
    i(),
    e.code = n.DynamicCode.getByKey(l, null, c),
    e.views = null,
    e.$watch("dateRange", s, !0),
    e.$watch("code.title", function(t) {
    ...
    var i = "/mycodes";
    t.next && "/" != t.next && (i = t.next),
    e.$watch("auth.isSignedIn", function(e) {
        e && r()
    }),
        ...
        link: function(t, n, o) {
            t.$watch(o.qrDynamicPreview, function(t) {
                ...
                case "contact":
                    ...
                    r = [r.filter(_.identity).join(" ")],
                    r.push(a.organization),
                    r = r.filter(_.identity),
                    o = r.join(", ");
                    break;
                case "sms":
    ...
    return {
        ...
        link: function(e, a, r) {
            function i(e) {
                ...
                return t.addColumn("date", "Date"),
                t.addColumn("number", "Views"),
...
angular.module("qrApp.services").factory("qrBackend", ["resourceStore", "$q", "$http", "dateUtils", function(e, t, n, o) {
    function a(e, t, a) {
        ...
        return t && a && (i += "?dateFrom=" + o.formatDate(t) + "&dateTo=" + o.formatDate(a)),
        n.get(i).then(r)
    }
    function r() {
        return null === s && (s = [],
        n.get("/api/timezones").success(function(e) {
            var t = e.zones;
    ...
    return {
        ...
        link: function(o, a, r) {
            ...
            var u = a[0]
              ...
              , v = !0;
            o.loading = !1,
            document.addEventListener("scroll", l, !0),
            m.bind("resize", o.$apply.bind(o, c)),
            o.$on("$destroy", d),
            c()
        }
    }
...
angular.module("qrApp.services").factory("auth", ["$window", "$http", "$rootScope", "$q", "$timeout", "$location", "analytics", function(e, t, n, o, a, r, i) {
    ...
    function c() {
        g && (g.reject(),
        g = null),
        i.trackEvent("Auth", "Popup", "open");
        var t = o.defer();
        if (h = e.open("/api/signin", "signin_popup", "height=500,width=900")) {
            var n = function() {
                a(function() {
                    !h || h.closed ? v.isSignedIn || (t.reject(),
                    i.trackEvent("Auth", "Popup", "cancel")) : n()
                }, 500)
            };
            n(),
            g = t
    ...
    function l(e) {
        e && angular.isObject(e) ? (v.isSignedIn = !0,
        v.nick = e.nick,
        m = e,
        g && (g.resolve(),
        g = null)) : (m = null,
    ...
    function p() {
        return v.isSignedIn ? !1 : (r.search("next", r.path()),
        r.path("/signin"),
        !0)
    }
    var m, h = null, g = null;
    e.w69b_signed_in = function(e) {
        i.trackEvent("Auth", "Popup", "success"),
        l(e),
        n.$digest()
    }
    ;
    ...
    this.$get = ["$rootScope", "auth", "$location", function(e, t, n) {
        return e.$on("$routeChangeStart", function(e, o) {
            o.authRequired && !t.isSignedIn() && (o.controller = void 0,
            o.template = void 0,
            o.templateUrl = void 0,
            o.redirectTo = "/signin",
            o.params = {
                next: n.path()
            })
...
angular.module("qrApp.ctrls").controller("GenerateCtrl", ["$scope", "auth", "qrBackend", "$location", "$routeParams", "analytics", "toolbarSpinner", function(e, t, n, o, a, r, i) {
    ...
    e.convertToDynamic = function() {
        t.withAuth(function() {
            r.trackEvent("MyCodes", "Create", "convert"),
            i.show();
            var t = new s({
            ...
            t.$save(function() {
                i.hide(),
                o.path("/mycodes/" + t.qrid)
            })
        })
    }
    ;
    var l = e.$watch("qrcode", function(t, n) {
        angular.equals(t, n) || (l(),
        e.modified = !0)
    }, !0)
}
]),
angular.module("qrApp.services").factory("strUtils", function() {
    ...
    function t(t, o, a) {
        if (!(t > o))
            for (var r = new Date(t); !e(r, o); r = n(r))
                a(r)
    }
    function n(e) {
        var t = new Date(e);
...
angular.module("qrApp.directives").directive("dateRange", function() {
    return {
        ...
        controller: ["$scope", function(e) {
            e.pickerShown = !1,
            e.maxDate = new Date,
            e.maxDate.setDate(e.maxDate.getDate() + 1)
        }
        ]
    }
}),
angular.module("qrApp.services").factory("resourceStore", ["$q", "$http", function(e, t) {
    ...
    function o(o, a) {
        ...
        r.getByKey = function(n, o, a) {
            var l, d = c.get(n);
            return d ? l = e.when(d) : (d = new r,
            l = t.get(s(n)).success(function(e) {
                angular.copy(e, d)
            }).error(function() {
                c.delete(n)
            }),
        ...
        return r.list = function() {
            ...
            return n.loadNextPage = function() {
                ...
                return t.get(o, {
                    ...
                    n.nextCursor = e.cursor,
                    n.firstPageLoaded = !0,
                    i.resolve(e.cursor ? !0 : !1)
                }).error(i.reject),
                i.promise
            }
            ,
...
angular.module("qrApp.services").provider("httpInterceptor", function() {
    ...
    this.$get = ["$q", "$injector", "$location", "$rootScope", "$timeout", function(n, o, a, r, i) {
        ...
        function l(e, t) {
            ...
            return n.retryCount ? n.retryCount++ : n.retryCount = 1,
            !t || t >= n.retryCount ? c(n) : null
        }
        function d(o) {
            var i = o.status;
            if (0 === i)
            ...
            if (i >= 500 && 600 > i) {
                ...
                403 == i ? !r.auth || !r.auth.isSignedIn && a.path() != t ? (a.search("next", a.path()),
                a.path(t)) : r.$broadcast("http:error", "auth", o) : 404 == i ? r.$broadcast("http:error", "notfound", o) : r.$broadcast("http:error", "unknown", o);
            return n.reject(o)
        }
        var u;
        return {
...
angular.module("qrApp.services").factory("httpErrorNotifier", ["$rootScope", "statusbar", "$timeout", "analytics", function(e, t, n, o) {
    function a(e, n, a) {
        if (a.config.notifyErrors !== !1) {
            i(),
            "unknown" == n || "server" == n ? t.showError("Oups! An error occured during communication with our backend. Please try to reload the page.", null) : "auth" == n ? t.showMessage("You are not allowed to view this page.") : "notfound" == n && t.showMessage("The requested page does not exist.");
    ...
    function r(e) {
        var n = "Failed to communicate with backend. "
          , o = Math.floor(e / 1e3);
        n += 0 >= o ? "Retrying..." : "Retrying in " + o + " seconds.",
        t.showMessage(n, 3e3)
    }
    function i() {
        c && (n.cancel(c),
    ...
    function s(e, t, o) {
        ...
        t.notifyErrors !== !1 && (3e3 > o || (i(),
        r(o),
        c = n(a, 1e3)))
    }
    var c = null;
    return e.$on("http:error", a),
    e.$on("http:retryScheduled", s),
    {}
}
]),
...
angular.module("qrApp.directives").directive("googBottomAd", function() {
    return {
        restrict: "A",
        template: '<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-9877465651415243" data-ad-slot="3288480654" data-ad-format="auto"></ins>',
